<template>
  <div py-8 justify-center px-2>
    <p class="font-tous tracking-widest text-xs">
      Lorem ipsum
    </p>
    <h1 class="font-tous text-[34px]">
      #LOREM
    </h1>
    <p text-xs py-4>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis a mi fringilla nisi condimentum tincidunt.
    </p>
    <p text-xs>
      Donec placerat gravida imperdiet. Sed gravida pretium pulvinar. Duis porttitor dolor rhoncus, tempus enim id, lacinia elit. Aliquam posuere felis in placerat luctus.
    </p>
